...
const Assistant = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: 'Hello! 👋 I\'m Subham Karmakar. I can help you learn more about me, answer questions about the myself and my skills, or guide you through the site. How can I help you today?'
    }
  ]);
  ...
  return (
    <div className='fixed bottom-8 right-20 z-50'>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className='absolute bottom-10 right-0 w-80 h-[500px] bg-zinc-400/20 dark:bg-zinc-800/30 backdrop-blur-lg rounded-md shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)] dark:shadow-[inset_0_2px_4px_rgba(255,255,255,0.1)] border border-zinc-300/30 dark:border-zinc-700/30 flex flex-col overflow-hidden'
          >
            {/* Header */}
            <div className='bg-zinc-300/20 dark:bg-zinc-700/30 backdrop-blur-md p-3 flex items-center justify-between border-b border-zinc-300/30 dark:border-zinc-700/30'>
            ...
            {/* Input Area */}
            <div className='absolute bottom-0 right-0 left-0 p-2 border-t border-zinc-300/30 dark:border-zinc-700/30 bg-zinc-300/20 dark:bg-zinc-700/20 backdrop-blur-md'>
              <div className='flex items-center gap-2'>
                <input
                  ref={inputRef}
                  type="text"
      ...
      <button
        ...
        className='bg-zinc-900 dark:bg-white w-10 h-10 rounded-full flex items-center justify-center hover:scale-105 hover:bg-zinc-200 transition duration-300 ease-in shadow-lg'
      >
